...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '收集，文本, Ai，服务器,WordPress，图像,主题,NotionNext,NotionNext',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '无', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '收集，文本, Ai，服务器,WordPress，图像,主题,NotionNext,NotionNext', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.liuliangka.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '收集，文本, Ai，服务器,WordPress，图像,主题,NotionNext,NotionNext', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://oss.tool.lu/cache/202401/18/22465486dwtwx111jdot5k.png.icon.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
